...
| Offset | Size | Description |
| --- | --- | --- |
| 0x0 | 1 | Station address size (always 18) |
| 0x1 | 18 | [Station address](#stationaddress) |
| 0x13 | 8 | [Constant id] |
| 0x1B | 2 | [Variable id] |
| 0x1D | 1 | `0x3`: [NAT filtering](#nat-filtering)<br>`0xC`: [NAT mapping](#nat-mapping)<br>`0x10`: Is IPv6 |
...
The session id is a random value that is generated by the host when the network is created. It is broadcasted as part of the [application data](LDN-Application-Data-(Pia)).
