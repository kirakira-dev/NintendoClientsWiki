...
## Examples
Let's say that the Switch has detected a system update. According to [sun](Sun-Server), the latest system update title id is `0100000000000816` and its title version is 1140851708.
