...
This page lists the technical reason behind the errors that may occur. The messages that are shown to the user can be found on a separate page: [[Wii U Error Messages]].
